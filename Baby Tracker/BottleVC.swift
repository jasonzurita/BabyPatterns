...
class BottleVC: UIViewController {
    ...
    private var _maxSupplyHeight:Float {
        return Float(bottleBaseView.frame.height +
            CGFloat(K.Defaults.BottleFillOverlapWithBottomFillImageHeight) -
    ...
    @IBAction func sliderValueChanged(_ sender: UISlider) {
        ...
        let amountFed = Float(ds.remainingSupply()) - (Float(ds.remainingSupply()) / _remainingSupplyHeight) * slider.value
